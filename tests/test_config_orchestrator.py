...
class TestEcFlowKeysAccessible:
    ...
    def test_ecflow_keys_present_in_execution(self, _write_yaml):
        """Verify that ecFlow configuration keys are correctly parsed into the execution dict."""
        path = _write_yaml("""\
            data:
              merra2: {}
            execution:
    ...
    def test_orchestrator_key_accessible_from_execution(self, _write_yaml):
        """Verify that the orchestrator key is accessible from the execution property."""
        path = _write_yaml("""\
            data:
              merra2: {}
            execution:
